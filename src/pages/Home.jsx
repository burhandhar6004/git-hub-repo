...
import { getAllUsers } from '../feature/auth/authSlice';
...
const Home = () => {
  ...
  return (
    <>
      <div className='bg-[#141C2F] sm:w-full h-[100vh] flex flex-col justify-center items-center'>
        <form className="md:w-[60%] w-full px-5   md:mx-40 md:py-5" onSubmit={handleSubmit}>
          ...
          <div className="relative">
            ...
            <input type="search" id="default-search" className="block w-full p-4 ps-10 sm:text-xl text-xs text-white border-none rounded-lg bg-[#1F2A48]  dark:bg-gray-700 dark:text-white" placeholder="Search GitHub Username..." required value={text} onChange={(e) => setText(e.target.value)} />
